...
這封信你可以三層讀:想直接玩,跳到 [怎麼拿來玩](#play);想知道我們動了什麼,順著往下看;想看技術細節,翻到 [怎麼做出來的](#tech)。

<a name="story"></a>
## 它說起了中文

它先是原封不動地開起來。那節紅色車廂滑過,**INDIANA JONES** 的金字亮起——然後在它底下,我們補上了設計過的中文片名:**印第安納·瓊斯 / 最後聖戰**,金色配色、深色描邊,對著原版那行 LAST CRUSADE 的金字調,像是它本來就該在那裡。連最底下那行版權聲明也跟著說起了中文:

![最後聖戰中文標題:火車車廂下疊上「印第安納·瓊斯 / 最後聖戰」中文片名](screenshots/crusade_cht_title.png)

> 金色 **印第安納·瓊斯 / 最後聖戰** 疊在火車車廂與版權行之間;引擎在標題房(room 79)即時把這兩行字按當下調色盤配色畫上去。
